...
#define NUM_LEDS             (144 * 3)
  ...
  // for Teensy 3.2 + Prop Shield
  #define DATA_PIN             11
  #define CLOCK_PIN            13
  #define USE_PROPSHIELD          // uncomment if connects prop shield by PJRC
  #ifdef USE_PROPSHIELD
    #define LEDENABLE_PIN         7
    #define AMPENABLE_PIN         5
  #endif
#else
...
#elif defined(USE_TEENSYAUDIO)
// Generated by Audio System Design Tool for Teensy Audio Library
// https://www.pjrc.com/teensy/gui/index.html?info=AudioMixer4#
#include <Audio.h>
...
#define twangStopTone()                   do{sine1.amplitude(0);}while(0)
#else
#define twangInitTone()                   do {} while(0)
